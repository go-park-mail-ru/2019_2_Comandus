...
func NewResponseUsecase(r user_response.Repository, fClient *clients.FreelancerClient, mclient *clients.ManagerClient,
	jClient *clients.JobClient) user_response.Usecase {
