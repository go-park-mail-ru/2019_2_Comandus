...
func easyjson92f8d27bDecodeGithubComGoParkMailRu20192ComandusInternalModel(in *jlexer.Lexer, out *Freelancer) {
...
func easyjson92f8d27bEncodeGithubComGoParkMailRu20192ComandusInternalModel(out *jwriter.Writer, in Freelancer) {
	out.RawByte('{')
	first := true
	_ = first
	{
