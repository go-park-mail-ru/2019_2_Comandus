...
func easyjson61e0ab13DecodeGithubComGoParkMailRu20192ComandusInternalModel2(in *jlexer.Lexer, out *ExtendedOutputFreelancer) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson61e0ab13EncodeGithubComGoParkMailRu20192ComandusInternalModel2(out *jwriter.Writer, in ExtendedOutputFreelancer) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson61e0ab13DecodeGithubComGoParkMailRu20192ComandusInternalModel3(in *jlexer.Lexer, out *ExtendResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Response":
			if in.IsNull() {
				...
				easyjson61e0ab13DecodeGithubComGoParkMailRu20192ComandusInternalModel4(in, out.R)
			}
		case "firstName":
			out.FirstName = string(in.String())
		case "lastName":
...
func easyjson61e0ab13EncodeGithubComGoParkMailRu20192ComandusInternalModel3(out *jwriter.Writer, in ExtendResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.R == nil {
			...
			easyjson61e0ab13EncodeGithubComGoParkMailRu20192ComandusInternalModel4(out, *in.R)
		}
	}
	{
		const prefix string = ",\"firstName\":"
...
func easyjson61e0ab13DecodeGithubComGoParkMailRu20192ComandusInternalModel4(in *jlexer.Lexer, out *Response) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson61e0ab13EncodeGithubComGoParkMailRu20192ComandusInternalModel4(out *jwriter.Writer, in Response) {
	out.RawByte('{')
	first := true
	_ = first
	{
