...
func easyjson4b608a57DecodeGithubComGoParkMailRu20192ComandusInternalModel(in *jlexer.Lexer, out *Company) {
...
func easyjson4b608a57EncodeGithubComGoParkMailRu20192ComandusInternalModel(out *jwriter.Writer, in Company) {
	out.RawByte('{')
	first := true
	_ = first
	{
